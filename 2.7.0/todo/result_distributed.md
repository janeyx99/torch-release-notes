...
### new features
- Context parallel
  - [dtensor] add aten._scaled_dot_product_cudnn_attention.default op support ([#148377](https://github.com/pytorch/pytorch/pull/148377))
- c10d
...
- c10d
  - c10d/ProcessGroup: Simplified `abort` and `shutdown` by adding both to `Backend` and `ProcessGroup` objects ([#148798](https://github.com/pytorch/pytorch/pull/148798))
...
- torchelastic
  ...
  - Made torchelastic etcd rendezvous publicly importable ([#145396](https://github.com/pytorch/pytorch/pull/145396))
...
- c10d
  ...
  - [PGNCCL] Associate tensor allocation support with NCCL version ([#146842](https://github.com/pytorch/pytorch/pull/146842))
...
- pipelining
  ...
  - [PP] Don't allow for num_microbatches > num_stages for single stage schedules ([#144702](https://github.com/pytorch/pytorch/pull/144702))
  - Fix shape_inference for V-schedules ([#147000](https://github.com/pytorch/pytorch/pull/147000))
### performance
- c10d
  - Changed alloc buffer size from 4000 to 4096 to be a power of 2 for TCPStore ([#145759](https://github.com/pytorch/pytorch/pull/145759))
...
- c10d
  ...
  - Flush file in file recorder ([#145458](https://github.com/pytorch/pytorch/pull/145458))
...
- Pipelining
  - [] Improve shape inference debug logging ([#144929](https://github.com/pytorch/pytorch/pull/144929))
